...
/*--------------------------------TYPEDEF------------------------------------*/
typedef long int li; typedef long long ll; typedef long long int lli;typedef long double ldb; typedef vector<int> vi; typedef vector<li> vli; typedef vector<ll> vll; typedef unordered_map<int, int> umapi; typedef pair<int, int> pii; typedef pair<long, long> pll; typedef unsigned long long int ull;
/*-----------------------------------------------------------------------------*/
